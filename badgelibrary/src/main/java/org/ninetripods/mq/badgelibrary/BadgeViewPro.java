        ...
        target.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (getParent() != null) {
                    ...
                    Log.i("onGlobalLayout","getParent() != null");
                }
                if (target.getParent() instanceof FrameLayout) {
                    Log.i("onGlobalLayout","getParent() = FrameLayout");
                    ...
                    Log.i("onGlobalLayout","getParent() = ViewGroup");
                    ...
                    Log.i("onGlobalLayout","ViewGroup setParams");
                    //set LayoutParams
