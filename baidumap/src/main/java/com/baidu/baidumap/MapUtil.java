...
//        baiduMap.clear();
        ...
        if (points.size() == 1) {
            OverlayOptions startOptions = new MarkerOptions().position(points.get(0)).icon(OverlayIconUtil.bmStart)
        ...
        OverlayOptions startOptions = new MarkerOptions()
                .position(startPoint).icon(OverlayIconUtil.bmStart)
                .zIndex(9).draggable(true);
    ...
    public void drawEndPoint(LatLng endPoint) {
        ...
        OverlayOptions endOptions = new MarkerOptions().position(endPoint)
                .icon(OverlayIconUtil.bmEnd).zIndex(9).draggable(true);
